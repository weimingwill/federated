...
root_dir=/mnt/lustre/$(whoami)/projects/easyfl
...
srun -u --partition=innova --job-name=femnist \
    ...
    python ${root_dir}/tensorflow_federated/python/examples/fedavg_main.py \
        ...
        --batch_size 64 --test_batch_size 64 --client_learning_rate 0.01 --test_all 2>&1 | tee log/tff-${now}.log
