...
srun -u --partition=innova --job-name=femnist \
    ...
    python ${root_dir}/tensorflow_federated/python/examples/simple_fedavg/fedavg_main.py \
        ...
        --total_rounds 100 --train_clients_per_round 10 --client_epochs_per_round 10 \
        --batch_size 64 --test_batch_size 64 --client_learning_rate 0.01 --test_all --gpu 1 2>&1 | tee log/tff-femnist-clean-${now}.log &
