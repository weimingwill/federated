...
def construct_character_level_datasets(data_dir,
                                       batch_size: int,
    ...
    train_client_data, test_client_data = (load_data(data_dir, "shakespeare"))
    ...
    preprocessed_test_client_data = test_client_data.preprocess(
        functools.partial(
            convert_snippets_to_character_sequence_examples,
    ...
    return preprocessed_train_client_data, preprocessed_test_client_data


def construct_centralized_datasets(data_dir,
