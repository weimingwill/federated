...
srun -u --partition=innova --job-name=tff-cifar \
    -n1 --gres=gpu:1 --ntasks-per-node=1 -w SG-IDC2-10-51-3-40 \
  ...
  --batch_size 64 --test_batch_size 64 --client_learning_rate 0.01 --test_in_server | tee log/tff-cifar10-1gpu-${now}.log &
