...
def threshold_histogram(histogram_keys, histogram_values, threshold):
  ...
  Args:
    histogram_keys: A tensor containing a list of strings representing the keys
      in the input histogram.
    histogram_values: A tensor containing a list of float representing the
      values for each key in `histogram_keys`.
